...
const file_transport_internet_quic_config_proto_rawDesc = "" +
	"\n" +
	"$transport/internet/quic/config.proto\x12$exclave.core.transport.internet.quic\x1a\x19google/protobuf/any.proto\x1a\x1dcommon/protocol/headers.proto\x1a common/protoext/extensions.proto\"\xf9\x01\n" +
	"\x06Config\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12H\n" +
	"\bsecurity\x18\x02 \x01(\v2,.exclave.core.common.protocol.SecurityConfigR\bsecurity\x12,\n" +
	...
	"\x15_connection_id_lengthB\xac\x01\n" +
	">com.github.exclavenetwork.exclave.core.transport.internet.quicP\x01ZAgithub.com/exclavenetwork/exclave-core/v5/transport/internet/quic\xaa\x02$Exclave.Core.Transport.Internet.Quicb\x06proto3"
...
var file_transport_internet_quic_config_proto_goTypes = []any{
	(*Config)(nil),                  // 0: exclave.core.transport.internet.quic.Config
...
var file_transport_internet_quic_config_proto_depIdxs = []int32{
	1, // 0: exclave.core.transport.internet.quic.Config.security:type_name -> exclave.core.common.protocol.SecurityConfig
	2, // 1: exclave.core.transport.internet.quic.Config.header:type_name -> google.protobuf.Any
